...
final class CompatFarmersDelight {
    ...
    private static void farmersdelight() {
        ...
        food("farmersdelight:bacon_sandwich", s("grain", 0.3167f), s("protein", 0.3892f), s("vegetable", 0.2941f));
        ...
        food("farmersdelight:chicken_sandwich", s("grain", 0.3113f), s("protein", 0.3726f), s("vegetable", 0.3161f));
        ...
        food("farmersdelight:dumplings", s("grain", 0.4753f), s("protein", 0.2575f), s("vegetable", 0.2672f));
        food("farmersdelight:egg_sandwich", s("grain", 0.3457f), s("protein", 0.6543f));
        food("farmersdelight:fish_stew", s("protein", 0.4131f), s("vegetable", 0.5869f));
        ...
        food("farmersdelight:grilled_salmon", s("fruit", 0.1554f), s("protein", 0.5352f), s("vegetable", 0.3094f));
        food("farmersdelight:ham", s("protein", 1.0f));
        food("farmersdelight:hamburger", s("grain", 0.2348f), s("protein", 0.4063f), s("vegetable", 0.3589f));
        ...
        food("farmersdelight:kelp_roll", s("grain", 0.5211f), s("vegetable", 0.4789f));
        ...
        food("farmersdelight:mutton_wrap", s("grain", 0.321f), s("protein", 0.3863f), s("vegetable", 0.2927f));
        ...
        food("farmersdelight:onion_soup", s("dairy", 0.1061f), s("grain", 0.1963f), s("vegetable", 0.6976f));
        ...
        food("farmersdelight:shepherds_pie_block", s("grain", 0.3538f), s("protein", 0.2886f), s("vegetable", 0.3576f));
        ...
        food("farmersdelight:steak_and_potatoes", s("grain", 0.1848f), s("protein", 0.38f), s("vegetable", 0.4352f));
        food("farmersdelight:stuffed_potato", s("protein", 0.1206f), s("vegetable", 0.8794f));
